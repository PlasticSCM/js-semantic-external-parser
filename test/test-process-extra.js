...
describe('Parser', function() {
	...
	describe('#processCodeExtraWithText()', function() {
		...
		it('should expand function ranges in object expressions', function(done) {
		...
		it('should expand function ranges in object expressions', function(done) {
			...
			parser.processCodeExtra('var foo = { bar: function() { }, baz: function() { } }', function(err, data) {
				assert.ifError(err)
				assert.ok(data)
				assert.ok(_.isEqual({
					"children": [
